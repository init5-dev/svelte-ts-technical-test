import { c as create_ssr_component, a as compute_rest_props, s as setContext, b as spread, e as escape_attribute_value, d as escape_object, f as add_attribute, g as getContext, h as escape, i as subscribe, v as validate_component } from "../../chunks/ssr.js";
  ...
  return `${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(NavBrand, "NavBrand").$$render($$result, { href: "/" }, {}, {
        default: () => {
          return `<span class="self-center whitespace-nowrap text-xl font-semibold dark:text-white" data-svelte-h="svelte-nqq8xx">Costs Management</span>`;
        }
        ...
        default: () => {
          ...
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/costs" }, {}, {
            default: () => {
              return `Costs`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/costs/new" }, {}, {
            default: () => {
              return `New`;
            }
          })} ${validate_component(NavLi, "NavLi").$$render($$result, { href: "/costs/upload" }, {}, {
            default: () => {
              return `Upload`;
            }
          })}`;
