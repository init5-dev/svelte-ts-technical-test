import { c as create_ssr_component, a as compute_rest_props, b as spread, d as escape_object, e as escape_attribute_value, f as add_attribute, g as getContext, v as validate_component, h as escape, k as compute_slots, i as subscribe } from "../../../../chunks/ssr.js";
...
const css$1 = {
  code: "form.svelte-1cxd4{display:flex;flex-direction:column;align-items:center;padding:20px;margin-bottom:20px}",
  map: null
};
const UploadFile = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<form method="POST" enctype="multipart/form-data" class="svelte-1cxd4">${validate_component(Label, "Label").$$render($$result, { class: "space-y-2 mb-2" }, {}, {
      default: () => {
...
const css = {
  code: "h1.svelte-1fg08ul{width:100vw;font-size:3rem;text-align:center}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<h1 class="svelte-1fg08ul" data-svelte-h="svelte-5f88os">Upload cost</h1> ${validate_component(UploadFile, "UploadFile").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
