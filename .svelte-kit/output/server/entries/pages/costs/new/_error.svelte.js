...
const Error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<div class="svelte-1hom5ut"><div class="error svelte-1hom5ut">${escape($page?.error?.message)}</div> <a href="/costs/new" class="svelte-1hom5ut" data-svelte-h="svelte-1un9exm">Retry</a> </div>`;
});
export {
  Error as default
};
